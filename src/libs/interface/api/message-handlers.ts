...
const notifyResult: (resultKey: string) => MessageHandler =
  (_resultKey: string) => () => {};
...
export const logMessageHandler = (
  _topic: string,
  payload: Buffer,
  _packet: unknown
) => {
...
export const dataCatalogMessageHandler = (
  _topic: string,
  payload: Buffer,
  _packet: unknown
) => {
...
export const handleAvailableDevices = (
  _topic: string,
  payload: Buffer,
  _packet: unknown
) => {
...
export const handleConnectedDevices = (
  _topic: string,
  payload: Buffer,
  _packet: unknown
) => {
